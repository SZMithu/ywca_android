...
class GmailWebViewActivity : ComponentActivity() {
    private var webViewPopUp: WebView? = null
    private var builder: AlertDialog? = null
    private var globalContext: Context? = null
    private val url = "https://mail.google.com/mail/?tab=rm&ogbl"
    ...
    internal inner class CustomChromeClient : WebChromeClient() {
        override fun onCreateWindow(
            ...
            builder = AlertDialog.Builder(this@GmailWebViewActivity).create()
            builder?.setTitle("")
